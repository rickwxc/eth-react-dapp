...
var testRegistrar = null;
ens.owner(namehash('test'),function(e,r){
	testRegistrar = fifsRegistrarContract.at(r);

	var name = 'hereismyname2018';
	//hereismynamebc
	testRegistrar.expiryTimes(web3.sha3(name),function(e,r){
		var t = new Date(r.toNumber() * 1000)
		console.log(t);
	})

	testRegistrar.expiryTimes(web3.sha3('hereismynamebc'),function(e,r){
		var t = new Date(r.toNumber() * 1000)
		console.log(t);
	})

	return;
	testRegistrar.register(web3.sha3(name), web3.eth.accounts[0], function(e,r){
		console.log(e)
		console.log(r)
	});
